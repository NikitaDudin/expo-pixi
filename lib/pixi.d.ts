...
/**
 * expo-pixi extends PIXI.Texture class
 *
 */
export declare class Texture extends PixiTexture {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  static fromExpoAsync<R extends Resource = Resource, RO = any>(
    source: string | number,
    options: IBaseTextureOptions<RO>,
    strict?: boolean
  ): Promise<PixiTexture<R>>;
}

/**
 * expo-pixi extends PIXI.Sprite class
 *
 */
export declare class Sprite extends PixiSprite {
  static fromExpoAsync(
    source: string | number,
